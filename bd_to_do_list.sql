...
-- usurio para la bd
CREATE USER 'admin_enma'@'localhost' IDENTIFIED BY '123456'; 
GRANT ALL PRIVILEGES ON bd_ToDoApp.* TO 'admin_enma'@'localhost'; 
FLUSH PRIVILEGES; 

-- base de datos

CREATE DATABASE bdToDoApp;
use bdToDoApp;
...
INSERT INTO tasks (title) VALUES ('Tarea 4');
INSERT INTO tasks (title) VALUES ('Tarea 5');
...
create database wordl;
use wordl;

CREATE USER 'TechXpert_2'@'localhost' IDENTIFIED BY 'techxpert';
GRANT ALL PRIVILEGES ON world.* TO 'TechXpert_2'@'localhost';
FLUSH PRIVILEGES;

CREATE USER 'enmanuel'@'localhost' IDENTIFIED BY 'password_enmanuel';
GRANT ALL PRIVILEGES ON world.* TO 'TechXpert_2'@'localhost';
